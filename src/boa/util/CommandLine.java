...
public final class CommandLine {
	...
	public static int getIntResponseWithinBounds(final int lower,
			final int upper, final String message) {
		int response;
		do {
			response = CommandLine.getIntResponse(String.format("%s (%d - %d)",
					message, lower, upper));
